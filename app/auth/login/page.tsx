    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="max-w-md w-full mx-4 animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground mt-4">Bienvenido de vuelta</h1>
          <p className="text-muted-foreground text-sm mt-1">Inicia sesión para acceder al panel</p>
        </div>
